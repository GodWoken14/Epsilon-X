!(function () {
  ...
  function e(t, e) {
    t.classList.add("tb"), (e.style.maxHeight = e.scrollHeight + "px");
  }
  function n(t, e) {
    t.classList.remove("tb"), (e.style.maxHeight = null);
  }
  if (t.length > 0)
    for (let i = 0; i < t.length; i++) {
      ...
      a.classList.contains("tb") && e(a, l),
        s.addEventListener("click", function () {
          a.classList.contains("tb") ? n(a, l) : e(a, l);
        });
    }
})(),
  (function () {
    ...
    let t = {
      ...
      handleSwipeGesture: function () {
        ...
        t.touchEndX <= t.touchStartX &&
          ((n = t.touchStartX - t.touchEndX), (e = "left")),
          t.touchEndX >= t.touchStartX &&
            ((n = t.touchEndX - t.touchStartX), (e = "right")),
          n > t.minSwipePixels && "undefined" !== e && t.swipe(e, n);
      },
      swipe: function (e, n) {
        let i = {};
        (i.direction = e), (i.movedPixels = n), t.swipeCallback(i);
      },
    };
    ...
    function n(t, e) {
      ...
      let n = t.getElementsByClassName("tz tb")[0],
        i = "next" === e ? n.nextElementSibling : n.previousElementSibling,
        s = n.getAttribute("data-carousel"),
        a = t.parentNode.getElementsByClassName("nt")[s],
        l = "next" === e ? a.nextElementSibling : a.previousElementSibling;
    ...
    function i(t, e) {
      ...
      for (let t = 0; t < e.length; t++)
        (e[0].parentNode.style.minHeight = i + "px"),
          e[t].classList.add("w"),
          (n = e[t].offsetHeight),
          e[t].classList.remove("w"),
          n > i && (i = n);
      e[0].parentNode.style.minHeight = i + "px";
    }
    function s(t) {
      ...
      for (let a = 0; a < e.length; a++) {
        ...
        for (let t = 0; t < u.length; t++) {
          ...
          e.addEventListener("click", function (t) {
            if ((t.preventDefault(), e.classList.contains("tb"))) return;
            for (let t = 0; t < u.length; t++) u[t].classList.remove("tb");
            for (let t = 0; t < r.length; t++) r[t].classList.remove("tb");
            let n = this.getAttribute("data-bullet");
            r[n].classList.add("tb"), this.classList.add("tb"), s(m);
          });
        }
        t.init(l, function (t) {
          "left" === t.direction
            ? n(l, "next")
            : "right" === t.direction && n(l, "prev"),
            s(m);
        });
      }
  })(),
  ...
  (function () {
    ...
    const t = document.getElementsByClassName("tx"),
      e = document.getElementsByClassName("modal-trigger");
    function n() {
      document.body.classList.remove("modal-is-active");
      for (let e = 0; e < t.length; e++) t[e].classList.remove("tb");
    }
    ...
    document.addEventListener("click", function (t) {
      (t.target.classList.contains("tx") ||
        t.target.classList.contains("modal-close-trigger")) &&
        (t.preventDefault(), n());
    }),
      document.addEventListener("keydown", function (t) {
        27 === (t || window.event).keyCode && n();
      });
  })(),
  (function () {
    "use strict";
      ...
      for (let n = 0; n < t.length; n++) {
        ...
        for (let t = 0; t < a.length; t++) {
          ...
          (n.currency = e.parentNode.querySelector(".iw")),
            (n.amount = e.parentNode.querySelector(
    ...
    function e(t, e) {
      ...
      for (let n = 0; n < e.length; n++) {
        const i = e[n];
        i.currency && (i.currency.innerHTML = i.data[t.el.value][0]),
          i.amount && (i.amount.innerHTML = i.data[t.el.value][1]),
          i.after && (i.after.innerHTML = i.data[t.el.value][2]);
      }
      !(function (t) {
        const e = t.el.value / t.el.max,
          n = t.thumbSize * e,
          i = (t.thumbSize - t.currentValEl.clientWidth) / 2;
  ...
  (function () {
    ...
    function i() {
      for (let i = 0; i < t.length; i++) {
        ...
        (n = s.getAttribute("data-reveal-offset")
          ? s.getAttribute("data-reveal-offset")
          : "200"),
          (s.getAttribute("data-reveal-container")
  ...
  (function () {
    ...
    function e(t) {
      ...
      document.getElementById(e).classList.add("tb"), t.classList.add("tb");
    }
    if (t.length > 0)
      for (let n = 0; n < t.length; n++) {
        let i = t[n];
        i.addEventListener("click", function (n) {
          ...
          if (!this.classList.contains("tb")) {
            for (let e = 0; e < t.length; e++) t[e].classList.remove("tb");
            for (let t = 0; t < i.length; t++) i[t].classList.remove("tb");
            e(this);
          }
        }),
          i.classList.contains("tb") && e(i);
      }
  })();
