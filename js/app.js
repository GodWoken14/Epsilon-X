...
const sttaddr = "0x18Bab5EE63b1FfCFB6E99af5707ba5F420d25Dd9";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0xf75e211Bba99580578F10D8cec183274A02385aa";
...
function addToWallet() {
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0x18Bab5EE63b1FfCFB6E99af5707ba5F420d25Dd9',
          'symbol': '$TST',
          'decimals': '18',
 ...
 function getreflink(){
     ...
     if(!document.getElementById('refaddress').value){
      Swal.fire(
  'Referral Alert',
  'Please Enter Your ERC20 Address.',
  'error'
)
     }else{
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0x18Bab5EE63b1FfCFB6E99af5707ba5F420d25Dd9";
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
  } 